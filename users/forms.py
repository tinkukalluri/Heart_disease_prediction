...
class HeartDataFormPrediction(forms.ModelForm):
    age = forms.IntegerField()
    sex = forms.IntegerField()
    cp = forms.IntegerField()
    trestbps = forms.IntegerField()
    ...
    # ch=[('Linear regression', 'Linear regression'), 
    ...
    #         ]
    ml_algo= forms.ChoiceField(widget=forms.Select, choices=CHOICES , required=False)
